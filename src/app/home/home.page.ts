...
export class HomePage implements OnInit, AfterViewInit {
  ...
  constructor(public preferences: PreferencesService, private modalService: NgbModal,
  ...
  ngOnInit(): void {
    //setTimeout(()=>this.presentPopover(),3000);
  }
  ...
  presentPopover(e: Event) {
    ...
    {screenX:11,screenY:11,clientX:11,clientY:11,});
    console.log(ev);
